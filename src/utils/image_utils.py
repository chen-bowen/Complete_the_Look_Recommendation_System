...
def display_compatible_images(
    ...
    Image2 = np.asarray(Image.open(f"{cfg.DATASET_DIR}/data/fashion_v2/train_single/{im2}").resize(input_image_size))
    Image3 = np.asarray(Image.open(f"{cfg.DATASET_DIR}/data/fashion_v2/train_single/{im3}").resize(input_image_size))
    Image4 = np.asarray(Image.open(f"{cfg.DATASET_DIR}/data/fashion_v2/train_single/{im4}").resize(input_image_size))
    Image5 = np.asarray(Image.open(f"{cfg.DATASET_DIR}/data/fashion_v2/train_single/{im5}").resize(input_image_size))
    Image6 = np.asarray(Image.open(f"{cfg.DATASET_DIR}/data/fashion_v2/train_single/{im6}").resize(input_image_size))
...
if __name__ == "__main__":
    ...
    output = {
            'input_product': 
                {'product_id': 32980, 'image_single_signature': '174d42a13a50ab3fbb61615bd26b399c_Skirts', 'product_type': 'Skirts'}, 
            'recommended_compatible_products': [
                {'product_id': 409990, 'image_single_signature': 'e7ffaf2f4ab71f03ec0dc64fd07861ff_Handbags', 'product_type': 'Handbags', 'compatibility_score': 0.9992280602455139}, 
                {'product_id': 36287, 'image_single_signature': '192396af62d98cdea94153465b975d2c_Dresses', 'product_type': 'Dresses', 'compatibility_score': 0.9991121292114258}, 
                {'product_id': 51877, 'image_single_signature': '21a6d5501760e74d9b69b999d5746ce2_Shorts', 'product_type': 'Shorts', 'compatibility_score': 0.9990701675415039}, 
                {'product_id': 426039, 'image_single_signature': 'f0de75fa8c7113124ec22bb54ca48704_Coats & Jackets', 'product_type': 'Coats & Jackets', 'compatibility_score': 0.9990623593330383}, 
                {'product_id': 291004, 'image_single_signature': 'a6a978a3fc6c0593808fac941acd8d94_Hats', 'product_type': 'Hats', 'compatibility_score': 0.9989411234855652}
                ]
            }
