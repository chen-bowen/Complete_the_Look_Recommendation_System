...
from Dataset import ProductAndSceneDataset
...
def build_metadata_csv():
        ...
        if not class_folder_name.startswith("."):
            ...
            for image_name in os.listdir(class_folder_path):
                if not image_name.startswith("."):
                    ...
                    tmp = pd.DataFrame(
                        [os.path.join(class_folder_path, image_name), class_folder_name]
                    ).T
    ...
    # save to csv
    images_df.to_csv("./dataset_metadata.csv")
...
def dataloader(metadata_csv):
    ...
    dataset = ProductAndSceneDataset(cfg.RAW_DATA_FOLDER, metadata_csv, transform=transformations)
...
if __name__ == "__main__":
    ...
    build_metadata_csv()
    dl = dataloader(metadata_csv="dataset_metadata.csv")
